export default function EventDetailsLoading() {
  return (
    <div>
      <div className="flex flex-col gap-8 items-center mb-5 animate-pulse">
        <div className="h-10 md:h-16 bg-gray-700 rounded w-3/4" />
        <div className="h-8 md:h-12 bg-gray-700 rounded w-2/3" />
      </div>

      <div className="min-h-dvh flex justify-between gap-16 flex-col mb-20 items-center md:flex-row md:items-start animate-pulse">
